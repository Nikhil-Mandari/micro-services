...
import com.studenttribe.eurekaservice.userservice.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public UserResponseDto update(UserRequestDto userRequestDto) throws UserNotFoundException {
        User user = userRepository.findByEmail(userRequestDto.getEmail())
                .orElseThrow(() -> new UserNotFoundException("User not found with email : " + userRequestDto.getEmail()));
